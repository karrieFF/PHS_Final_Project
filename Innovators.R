...
p_innovators <- 0.025  # Proportion of innovators
...
adoption_efficacy <- 1500

for (i in innovators_indice){
  baseline_value <- original_data[i,'Baseline_PA']
  follow_up_value <- baseline_value + adoption_efficacy
  original_data[i,'Follow_up_PA'] <- follow_up_value
}
original_data
